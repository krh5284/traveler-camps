...
<!-- Colorado -->
{{< accordionItem title="Colorado" open=false >}}
...
<!-- Idaho -->
{{< accordionItem title="Idaho" open=false >}}
...
<!-- Illinois-->
{{< accordionItem title="Illinois" open=false >}}
...
<!-- Indiana-->
{{< accordionItem title="Indiana" open=false >}}
...
<!-- Maryland -->
{{< accordionItem title="Maryland" open=false >}}
- [Woodlands Camping Resort]({{% relref "campgrounds/woodlands-camping-resort" %}})
{{< /accordionItem >}}


<!-- Missouri -->
{{< accordionItem title="Missouri" open=false >}}
